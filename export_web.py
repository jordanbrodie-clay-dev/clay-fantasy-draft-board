...
def main():
    ...
    for p in b:
        ...
        out.append({
            ...
            "bs": p.get("base_playr_score", p["playr_score"]),
            "bpr": p.get("base_position_rank", p["model_pos_rank"]),
            "bpj": p.get("base_proj_ppg", p.get("proj_ppg")),
            "bi": p.get("base_insights", p["insights"]),
