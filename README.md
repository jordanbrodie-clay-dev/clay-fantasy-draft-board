...
Scoring: six weighted buckets (opportunity, production, situation, efficiency, market, regression) × a risk multiplier → value over replacement → anchored to expert consensus.

Backtested against five seasons of real preseason ADP (2020–2025).

## Columns worth knowing

- **Clay rank** — where to actually draft him. Accounts for positional scarcity, anchored to consensus.
